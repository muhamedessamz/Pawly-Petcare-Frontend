    ...
    return (
        <Card className="group overflow-hidden border-gray-100 flex flex-col h-full hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500">
            ...
            <CardHeader className="pb-2 pt-6 text-center">
                <CardTitle className="text-lg leading-tight group-hover:text-primary transition-colors line-clamp-1 mx-auto" title={product.name}>
                    {product.name}
                </CardTitle>
                <div className="flex items-center justify-center gap-1.5 text-sm font-bold text-playful mt-2">
            ...
            <CardContent className="flex-grow pb-4 px-6 text-center">

            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                <div className="lg:col-span-8 space-y-12">
                    <header>
                        ...
                        <div className="flex items-center gap-2 text-sm font-bold text-gray-400 border-b border-gray-100 pb-8">
                    ...
                    <form onSubmit={handlePurchase} className="space-y-16">
                        ...
                        <section className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <Input placeholder="Full Name" className="h-14 rounded-xl" required />
                                <Input placeholder="Email Address" type="email" className="h-14 rounded-xl" required />
                                <Input placeholder="Street Address" className="h-14 rounded-xl md:col-span-2" required />
                                <Input placeholder="City" className="h-14 rounded-xl" required />
                                <Input placeholder="ZIP Code" className="h-14 rounded-xl" required />
                            </div>
                        </section>
                        ...
                        <section className="space-y-8">
                            ...
                            <Card className="rounded-3xl border-gray-100 bg-gray-50/50 p-8 space-y-8">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="md:col-span-2 relative group">
                                        <Input placeholder="Card Number" className="h-16 rounded-2xl pl-16 font-black" required />
                                        <CreditCard className="absolute left-6 top-1/2 -translate-y-1/2 text-gray-300" size={24} />
                                    </div>
                                    <Input placeholder="MM / YY" className="h-16 rounded-2xl font-black text-center" required />
                                    <Input placeholder="CVC" className="h-16 rounded-2xl font-black text-center" required />
                                </div>
                        ...
                        <Button type="submit" className="w-full h-20 rounded-[1.5rem] text-xl font-black shadow-xl shadow-primary/20">
                            Confirm & Pay ${(Math.random() * 100 + 50).toFixed(2)}
                        </Button>
                    </form>
                </div>
